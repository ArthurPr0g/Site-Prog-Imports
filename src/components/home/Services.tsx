  ...
  return (
    <section id="servicos" className="mx-auto max-w-[1280px] px-6 pt-22">
      ...
      <div className="grid grid-cols-[repeat(auto-fill,minmax(220px,1fr))] gap-3.5">
        {services.map((s) => {
          const icon = { Icon: getServiceIcon(s.name) };
          return (
            <div
              key={s.id}
            ...
            >
              <div className="mb-4.5 grid h-10 w-10 place-items-center rounded-xl border border-accent/30 bg-accent/10 text-accent">
