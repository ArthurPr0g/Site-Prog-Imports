...
export default function AccountError({ error, reset }: { error: Error & { digest?: string }; reset: () => void }) {
  ...
  return (
    <div className="rounded-[20px] border border-error/30 bg-card p-8 text-center">
      ...
      <p className="mx-auto mb-5 max-w-md text-sm text-fg-tertiary">
        Não foi possível carregar esta seção da sua conta. Tente novamente em instantes.
      </p>
      <button
        onClick={reset}
